...
{
  public class Day24Part2 : ISolution
  {
    ...
    public int Solve()
    {
      ...
      var longestBridge = currentChains.Max(c => c.Components.Count());
      return currentChains.Where(c => c.Components.Count() == longestBridge).Select(chain => chain.Components.Sum(c => c.Item1 + c.Item2)).Max();
    }
